    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imCalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(day5.this, Calendar.class);
        ...
        imCheckIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(day5.this, CheckIn.class);
                startActivity(intent);
            }
        });
        ...
        imMessages.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(day5.this, Messages.class);
                startActivity(intent);
            }
        });
        ...
        imQuote.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(day5.this, Quote.class);
                startActivity(intent);
            }
        });
    }
